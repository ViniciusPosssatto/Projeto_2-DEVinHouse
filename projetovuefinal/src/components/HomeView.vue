<template>
  <div class="row">
    ...
    <div class="col-6 ms-5 mb-4 mt-4">
    ...
    <div class="col-5 ms-5 mb-3">
      <div class="col-11 ms-5 p-5 card text-white bg-dark mt-3">
        ...
        <p class="mt-3">Ou se preferir, cadastre um colaborador:</p>
    ...
    <footer class="bg-light text-center">
      ...
      <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
        © 2002 Copyright: TrOnline ltd. -> Telefone: 0800-059-3001 E-mail: biblioteca-vir@email.com
      </div>
      <!-- Copyright -->
    </footer>
  </div>
